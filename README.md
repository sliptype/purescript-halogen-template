...
This fork uses `psc-package` instead of Bower.

## Prerequisites

This guide assumes you already have Git and Node.js installed with `npm` somewhere on your path.

If you don't already have `psc-package`, you can install it like this:
...
``` shell
git clone https://github.com/sliptype/purescript-halogen-template.git my-halogen-project
